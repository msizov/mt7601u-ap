...
static int mt7601u_config(struct ieee80211_hw *hw, int link_id, u32 changed)
{
	struct mt7601u_dev *dev = hw->priv;
	int ret = 0;
			 ...
			 struct ieee80211_bss_conf *info, u64 changed)
{
	...
	if (changed & BSS_CHANGED_BEACON_INT) {
		...
		mt7601u_beacon_set_timer(dev, info->beacon_int);
	}
...
static int mt7601u_set_rts_threshold(struct ieee80211_hw *hw, int link_id, u32 value)
{
	struct mt7601u_dev *dev = hw->priv;
